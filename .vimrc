...
" Coffeescript/Javascript stuff
au BufRead,BufNewFile *.coffee,*.js,*.less,*.css setl tabstop=2 shiftwidth=2 expandtab
...
au BufRead,BufNewFile *.c,*.cc,*.cpp,*.h set formatoptions-=c formatoptions-=o formatoptions-=r
